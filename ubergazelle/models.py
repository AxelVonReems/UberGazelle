...
class Regions(db.Model):
    ...
    # region_drivers = db.relationship(
    #     'Drivers', secondary='regions_drivers'
    #     )
...
class Drivers(db.Model):
    ...
    # driver_regions = db.relationship(
    #     'Regions', secondary='regions_drivers', overlaps='region_drivers'
    #     )
...
# regions_drivers = db.Table(
#     'regions_drivers',
#     db.Column(
#         'regions_id', db.ForeignKey('regions.id'), primary_key=True
#         ),
#     db.Column(
#         'drivers_id', db.ForeignKey('drivers.id'), primary_key=True
#         ),
# )
